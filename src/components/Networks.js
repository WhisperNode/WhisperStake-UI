      ...
      <div className="d-flex flex-nowrap justify-content-center align-items-start mb-3 position-relative">
        ...
        <div className="d-lg-flex d-none position-absolute mx-auto justify-content-center align-self-center">
          <Nav fill variant="pillls" activeKey={filter.group} className={`flex-row${props.modal ? ' small' : ''}`} onSelect={(e) => setFilter({...filter, group: e})}>
            ...
            <Nav.Item>
              <Nav.Link eventKey="featured" className={`bttn-tertiary ${props.theme === 'dark' ? 'dark-link' : 'light-link'} `} disabled={filteredNetworks(networks, {...filter, group: 'featured'}).length < 1}>Featured</Nav.Link>
            </Nav.Item>
            <Nav.Item>
        ...
        <div className="d-flex d-lg-none justify-content-end select-wrapper">
